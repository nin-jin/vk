...
declare namespace $ {
    class $vk_fund_rise extends $mol_store<{
        ...
        aim(next?: string): string;
        payment(next?: string): string;
        author(next?: string): string;
        deadline(next?: $mol_time_moment | null): $mol_time_moment | null;
        period(next?: $mol_time_duration | null): "" | $mol_time_duration;
        amount(next?: number): number;
        achieved(next?: number): number;
    }
}
...
declare namespace $ {
    class $vk_fund_store extends $mol_store<{
        ...
        rises(): $vk_fund_rise[];
        rise(index: number): $vk_fund_rise;
    }
}
...
declare namespace $.$$ {
    class $vk_image_pick extends $.$vk_image_pick {
        ...
        content(): ($mol_attach_item | $mol_attach_add)[];
    }
}
...
declare namespace $.$$ {
    class $vk_fund_rise_edit extends $.$vk_fund_rise_edit {
        ...
        aim(next?: string): string;
        aim_bid(): string;
        amount(next?: number | null): number;
        amount_bid(): string;
        period(next?: string | null): string;
        payment(next?: string): string;
        payment_bid(): string;
        author(next?: string): string;
        deadline(next?: string | null): string | $mol_time_moment | null;
        submit(): void;
    }
}
...
declare namespace $ {
    class $vk_fund extends $mol_book2 {
        ...
        plugins(): readonly any[];
        pages(): readonly any[];
        Rise_row(id: any): $$.$vk_fund_rise_card;
        Edit_page(id: any): $$.$vk_fund_rise_edit;
        ...
        Add(): $$.$mol_link;
        rise_list(): readonly any[];
        rise_list_hint(): string;
        Rise_list_add_icon(): $mol_icon_arrow_up_bold;
        Rise_list_hint(): $mol_view;
        Rise_list(): $$.$mol_list;
        List_page(): $$.$mol_page;
        rise(id: any): $vk_fund_rise;
        rise_arg(id: any): {};
    }
}
...
declare namespace $.$$ {
    class $vk_fund extends $.$vk_fund {
        store(): $vk_fund_store;
        rise(id: number): $vk_fund_rise;
        rise_current(): number | null;
        pages(): ($mol_page | $vk_fund_rise_edit)[];
        rise_new_id(): string;
        rise_list(): $vk_fund_rise_card[];
        rise_arg(id: number): {
            rise: string;
        };
    }
