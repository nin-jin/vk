...
var $;
(function ($) {
    class $vk_fund_rise extends $.$mol_store {
        name(next) {
            var _a;
        ...
        image(next) {
            var _a;
            return (_a = this.value('image', next)) !== null && _a !== void 0 ? _a : '';
        }
        aim(next) {
            var _a;
            return (_a = this.value('aim', next)) !== null && _a !== void 0 ? _a : '';
        }
        payment(next) {
            var _a;
            return (_a = this.value('payment', next)) !== null && _a !== void 0 ? _a : '';
        }
        author(next) {
            var _a;
            return (_a = this.value('author', next)) !== null && _a !== void 0 ? _a : '';
        }
        deadline(next) {
    ...
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise.prototype, "deadline", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise.prototype, "period", null);
    $.$vk_fund_rise = $vk_fund_rise;
})($ || ($ = {}));
//rise.js.map
;
"use strict";
var $;
(function ($) {
    class $vk_fund_store extends $.$mol_store {
        rises() {
            return this.value('rises').map((stock, index) => this.rise(index));
        }
        rise(index) {
            var _a;
            return this.sub('rises')
                .sub(index, new $.$vk_fund_rise((_a = this.value('rises')[index]) !== null && _a !== void 0 ? _a : {}));
        }
    }
    __decorate([
        $.$mol_mem
    ], $vk_fund_store.prototype, "rises", null);
    __decorate([
        $.$mol_mem_key
    ], $vk_fund_store.prototype, "rise", null);
    $.$vk_fund_store = $vk_fund_store;
})($ || ($ = {}));
//store.js.map
;
"use strict";
...
var $;
(function ($) {
    class $vk_fund_rise_card extends $.$mol_view {
        store() {
            const obj = new this.$.$vk_fund_rise();
            return obj;
        }
        sub() {
            return [
        ...
        progress_text() {
            return this.$.$mol_locale.text('$vk_fund_rise_card_progress_text');
        }
        Progress_text() {
            const obj = new this.$.$mol_view();
            obj.sub = () => [
        ...
        Stat() {
            ...
            obj.sub = () => [
                this.Progress_text(),
                this.Progress_portion()
            ];
            return obj;
        }
        Support() {
            const obj = new this.$.$mol_button_major();
            obj.title = () => this.$.$mol_locale.text('$vk_fund_rise_card_Support_title');
            return obj;
        }
        Addon() {
    ...
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_card.prototype, "store", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_card.prototype, "Image", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_card.prototype, "Title", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_card.prototype, "Aim", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_card.prototype, "Main", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_card.prototype, "Link", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_card.prototype, "Progress_text", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_card.prototype, "Progress_portion", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_card.prototype, "Stat", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_card.prototype, "Support", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_card.prototype, "Addon", null);
    $.$vk_fund_rise_card = $vk_fund_rise_card;
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        class $vk_fund_rise_card extends $.$vk_fund_rise_card {
            image() {
...
var $;
(function ($) {
    class $vk_image_pick extends $.$mol_attach {
        value(val) {
            if (val !== undefined)
                return val;
            return "";
    ...
    __decorate([
        $.$mol_mem
    ], $vk_image_pick.prototype, "value", null);
    $.$vk_image_pick = $vk_image_pick;
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        class $vk_image_pick extends $.$vk_image_pick {
            items(next) {
                var _a;
                return $.$mol_maybe(this.value(next && ((_a = next[next.length - 1]) === null || _a === void 0 ? void 0 : _a.url_thumb())) || null)
                    .map((_, i) => this.Item(i));
            }
            content() {
                return [
...
var $;
(function ($) {
    class $vk_fund_rise_edit extends $.$mol_page {
        title() {
            return this.$.$mol_locale.text('$vk_fund_rise_edit_title');
        }
        store() {
            const obj = new this.$.$vk_fund_rise();
            return obj;
        ...
        bid_required() {
            return this.$.$mol_locale.text('$vk_fund_rise_edit_bid_required');
        }
        body() {
            return [
                this.Image(),
        ...
        Image() {
            const obj = new this.$.$vk_image_pick();
            obj.value = (val) => this.image(val);
            return obj;
        }
        name_bid() {
            return "";
        ...
        Name_block() {
            ...
            obj.name = () => this.$.$mol_locale.text('$vk_fund_rise_edit_Name_block_name');
        ...
        Amount() {
            ...
            obj.value = (val) => this.amount(val);
            return obj;
        }
        Amount_block() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$vk_fund_rise_edit_Amount_block_name');
            obj.bid = () => this.amount_bid();
            obj.Content = () => this.Amount();
            return obj;
        }
        aim_bid() {
            return "";
        ...
        Aim() {
            const obj = new this.$.$mol_string();
            obj.value = (val) => this.aim(val);
            return obj;
        }
        Aim_block() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$vk_fund_rise_edit_Aim_block_name');
            obj.bid = () => this.aim_bid();
            obj.Content = () => this.Aim();
            return obj;
        }
        description(val) {
            if (val !== undefined)
        ...
        Description_block() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$vk_fund_rise_edit_Description_block_name');
        ...
        Deadline() {
            ...
            obj.value_moment = (val) => this.deadline(val);
            return obj;
        }
        Deadline_block() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$vk_fund_rise_edit_Deadline_block_name');
            obj.Content = () => this.Deadline();
            return obj;
        }
        period(val) {
            if (val !== undefined)
        ...
        periods() {
            return {
                "": this.$.$mol_locale.text('$vk_fund_rise_edit_periods_'),
                P7DT: this.$.$mol_locale.text('$vk_fund_rise_edit_periods_P7DT'),
                P1MT: this.$.$mol_locale.text('$vk_fund_rise_edit_periods_P1MT'),
                P3MT: this.$.$mol_locale.text('$vk_fund_rise_edit_periods_P3MT')
            };
        }
        Period() {
            const obj = new this.$.$mol_switch();
            obj.value = (val) => this.period(val);
            obj.options = () => this.periods();
            return obj;
        }
        Period_block() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$vk_fund_rise_edit_Period_block_name');
        ...
        Payment() {
            const obj = new this.$.$mol_switch();
            obj.value = (val) => this.payment(val);
            obj.options = () => this.payments();
            return obj;
        }
        Payment_block() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$vk_fund_rise_edit_Payment_block_name');
            obj.bid = () => this.payment_bid();
            obj.Content = () => this.Payment();
            return obj;
        }
        author_bid() {
            return "";
        ...
        Author() {
            const obj = new this.$.$mol_switch();
            obj.value = (val) => this.author(val);
            obj.options = () => this.authors();
            return obj;
        }
        Author_block() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$vk_fund_rise_edit_Author_block_name');
            obj.bid = () => this.author_bid();
            obj.Content = () => this.Author();
            return obj;
        }
        submit(event) {
            if (event !== undefined)
        ...
        Submit() {
            const obj = new this.$.$mol_button_major();
            obj.title = () => this.$.$mol_locale.text('$vk_fund_rise_edit_Submit_title');
    ...
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "store", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Close_icon", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Close", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "image", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Image", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "name", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Name", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Name_block", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "amount", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Amount", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Amount_block", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "aim", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Aim", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Aim_block", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "description", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Description", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Description_block", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "deadline", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Deadline", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Deadline_block", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "period", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Period", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Period_block", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "payment", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Payment", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Payment_block", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "author", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Author", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Author_block", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "submit", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Submit", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund_rise_edit.prototype, "Form", null);
    $.$vk_fund_rise_edit = $vk_fund_rise_edit;
})($ || ($ = {}));
...
(function ($) {
    const { rem } = $.$mol_style_unit;
    $.$mol_style_define($.$vk_fund_rise_edit, {
        Form: {
            padding: rem(.75),
        },
        Amount: {
...
(function ($) {
    var $$;
    (function ($$) {
        class $vk_fund_rise_edit extends $.$vk_fund_rise_edit {
            image(next) {
                return next !== null && next !== void 0 ? next : this.store().image();
            }
            name(next) {
                return next !== null && next !== void 0 ? next : this.store().name();
            }
            name_bid() {
                if (!this.name().trim())
            ...
            description(next) {
                return next !== null && next !== void 0 ? next : this.store().description();
            }
            aim(next) {
                return next !== null && next !== void 0 ? next : this.store().aim();
            }
            aim_bid() {
                if (!this.aim().trim())
                    return this.bid_required();
            ...
            amount(next) {
                var _a;
                return (_a = next !== null && next !== void 0 ? next : this.store().amount()) !== null && _a !== void 0 ? _a : null;
            }
            amount_bid() {
                if (this.amount() > 0)
                    return '';
            ...
            period(next) {
                var _a, _b;
                return (_b = next !== null && next !== void 0 ? next : (_a = this.store().period()) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : null;
            }
            payment(next) {
                var _a;
                return (_a = next !== null && next !== void 0 ? next : this.store().payment()) !== null && _a !== void 0 ? _a : '';
            }
            payment_bid() {
                if (!this.payment())
                    return this.bid_required();
            ...
            author(next) {
                var _a;
                return (_a = next !== null && next !== void 0 ? next : this.store().author()) !== null && _a !== void 0 ? _a : '';
            }
            deadline(next) {
                var _a;
                return (_a = next !== null && next !== void 0 ? next : this.store().deadline()) !== null && _a !== void 0 ? _a : null;
            }
            submit() {
                var _a, _b;
                this.store().data({
                    ...
                    author: this.author(),
                    deadline: (_b = (_a = this.deadline()) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : null,
                });
                const button = this.Close().dom_node();
                button.click();
            }
        }
        __decorate([
...
var $;
(function ($) {
    class $vk_fund extends $.$mol_book2 {
        store() {
            const obj = new this.$.$vk_fund_store({
                rises: []
            });
            return obj;
        }
        ...
        Rise_row(id) {
            const obj = new this.$.$vk_fund_rise_card();
            obj.store = () => this.rise(id);
            obj.arg = () => this.rise_arg(id);
            return obj;
        }
        Edit_page(id) {
            const obj = new this.$.$vk_fund_rise_edit();
            obj.payments = () => this.payments();
            obj.authors = () => this.signs();
            obj.store = () => this.rise(id);
            return obj;
        }
        Theme() {
        ...
        Add() {
            const obj = new this.$.$mol_link();
            obj.arg = () => ({
                rise: this.rise_new_id()
            });
            obj.hint = () => this.$.$mol_locale.text('$vk_fund_Add_hint');
            obj.sub = () => [
                this.Add_icon()
            ];
            return obj;
        ...
        rise_list_hint() {
            return this.$.$mol_locale.text('$vk_fund_rise_list_hint');
        }
        Rise_list_add_icon() {
        ...
        Rise_list_hint() {
            ...
            obj.sub = () => [
                this.rise_list_hint(),
                this.Rise_list_add_icon()
            ];
            return obj;
        }
        Rise_list() {
            const obj = new this.$.$mol_list();
            obj.rows = () => this.rise_list();
            obj.Empty = () => this.Rise_list_hint();
            return obj;
        }
        List_page() {
            const obj = new this.$.$mol_page();
            obj.title = () => this.$.$mol_locale.text('$vk_fund_List_page_title');
            obj.tools = () => [
                this.Sources(),
                this.Lights(),
                this.Add()
    ...
    __decorate([
        $.$mol_mem
    ], $vk_fund.prototype, "store", null);
    __decorate([
        $.$mol_mem_key
    ], $vk_fund.prototype, "Rise_row", null);
    __decorate([
        $.$mol_mem_key
    ], $vk_fund.prototype, "Edit_page", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund.prototype, "Theme", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund.prototype, "Sources", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund.prototype, "Lights", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund.prototype, "Add_icon", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund.prototype, "Add", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund.prototype, "Rise_list_add_icon", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund.prototype, "Rise_list_hint", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund.prototype, "Rise_list", null);
    __decorate([
        $.$mol_mem
    ], $vk_fund.prototype, "List_page", null);
    __decorate([
        $.$mol_mem_key
    ], $vk_fund.prototype, "rise", null);
    $.$vk_fund = $vk_fund;
})($ || ($ = {}));
//fund.view.tree.js.map
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $.$mol_mem
        ], $vk_fund.prototype, "rise_current", null);
        __decorate([
            $.$mol_mem
        ], $vk_fund.prototype, "rise_list", null);
        $$.$vk_fund = $vk_fund;
